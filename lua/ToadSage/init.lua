...
require("ToadSage.remaps")
require("ToadSage.set")
require("ToadSage.lazy_init")

-- Create an augroup for ToadSage-specific autocommands
local augroup = vim.api.nvim_create_augroup
local ToadSage = augroup("ToadSage", {})
